package edu.berziet.houserental.tenants.ui.requests;

import static edu.berziet.houserental.ApiUrl.IMAGE_URL;
import static edu.berziet.houserental.ApiUrl.TENANT_RENTAL_REQUESTS_URL;
...
import edu.berziet.houserental.shared.PropertyInfoFragment;
import edu.berziet.houserental.tools.HttpManager;
import edu.berziet.houserental.tools.SharedPrefManager;

public class TenantRentalRequestsFragment extends Fragment {

    private RecyclerView recyclerView;
    private RentalSqliteOpenHelper sqliteOpenHelper;
    public TenantRentalRequestsFragment() {
    }

    public static TenantRentalRequestsFragment newInstance() {
        TenantRentalRequestsFragment fragment = new TenantRentalRequestsFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tenant_rental_requests, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = view.findViewById(R.id.tenantRequests_recyclerView);
        recyclerView.setLayoutManager(new GridLayoutManager(requireContext(),1));
        SharedPrefManager sharedPrefManager = SharedPrefManager.getInstance(requireContext());
        String url = String.format(ApiUrl.TENANT_RENTAL_REQUESTS_URL,sharedPrefManager.getUserId());
    ...
    private class PropertyRecyclerAdapter extends RecyclerView.Adapter<RequestViewHolder> {
        ...
        public RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new RequestViewHolder(
                    View.inflate(parent.getContext(), R.layout.rental_request_item_layout, null)
            );
        }

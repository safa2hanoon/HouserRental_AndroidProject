package edu.berziet.houserental.tenants.ui.history;
...
public class TenantRentalHistoryFragment extends Fragment {
    ...
    public TenantRentalHistoryFragment() {
    }
    public static TenantRentalHistoryFragment newInstance(String tenantId) {
        TenantRentalHistoryFragment fragment = new TenantRentalHistoryFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tenant_rental_history, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = view.findViewById(R.id.tenantRentalHistory_recyclerView);
        recyclerView.setLayoutManager(new GridLayoutManager(requireContext(),1));
        SharedPrefManager sharedPrefManager = SharedPrefManager.getInstance(requireContext());
        String url = String.format(ApiUrl.TENANT_RENTAL_HISTORY_URL,sharedPrefManager.getUserId());
    ...
    private class RentalHistoryAdapter extends RecyclerView.Adapter<RentalHistoryViewHolder> {
        ...
        public RentalHistoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new RentalHistoryViewHolder(
                    View.inflate(parent.getContext(), R.layout.rental_history_item_layout, null)
            );
        }

...
public class DataLoader implements ApplicationRunner{
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		tenantService.addNewTenant(t);
		
		RentingAgency ra1 = new RentingAgency(
				"agency@mail.com",
				"agency1",
				"P@ssw0rd",
				palestine,
		...
		rentingAgencyService.addNewAgency(ra1);

		RentingAgency ra2 = new RentingAgency(
				"agency2@mail.com",
				"agency 2",
				"P@ssw0rd",
				palestine,
		...
		rentingAgencyService.addNewAgency(ra2);
		
		
		Property p1 = new Property(
				100,2,250,"furnished",false,false,2015,Calendar.getInstance().getTime(),
				"Second level apartment",jerusalim,ra1
				);
		propertyService.addNewProprty(p1);
		
		PropertyImage pImage = new PropertyImage();
		pImage.setFileName("p1.jpg");
		pImage.setProperty(p1);
		propertyImageServce.addPropertyImage(pImage);


		PropertyImage pImage1 = new PropertyImage();
		pImage1.setFileName("p1-2.jpg");
		pImage1.setProperty(p1);
		propertyImageServce.addPropertyImage(pImage1);
		
		Property p2 = new Property(
				100,2,150,"unfurnished",true,false,2019,Calendar.getInstance().getTime(),
				"first level apartment with garden",ramallah,ra1
				);
		propertyService.addNewProprty(p2);

		PropertyImage pImage2 = new PropertyImage();
		pImage2.setFileName("p2.jpg");
		pImage2.setProperty(p2);
		propertyImageServce.addPropertyImage(pImage2);
		

		Property p3 = new Property(
				150,2,250,"unfurnished",false,true,2019,Calendar.getInstance().getTime(),
				"Description about property, Description about property, Description about property, Description about property, Description about property, Description about property,",
				jerusalim,ra2
				);
		propertyService.addNewProprty(p3);

		PropertyImage pImage3 = new PropertyImage();
		pImage3.setFileName("p3.jpg");
		pImage3.setProperty(p3);
		propertyImageServce.addPropertyImage(pImage3);

		Property p4 = new Property(
				250,3,450,"furnished",true,true,2019,Calendar.getInstance().getTime(),
				"Description about property, Description about property, Description about property, Description about property, Description about property, Description about property,",
				ramallah,ra2
				);
		propertyService.addNewProprty(p4);

		PropertyImage pImage4 = new PropertyImage();
		pImage4.setFileName("p4.jpg");
		pImage4.setProperty(p4);
		propertyImageServce.addPropertyImage(pImage4);
		

		Property p5 = new Property(
				350,4,550,"furnished",false,false,2019,Calendar.getInstance().getTime(),
				"Description about property, Description about property, Description about property, Description about property, Description about property, Description about property,",
				jerusalim,ra2
				);
		propertyService.addNewProprty(p5);

		PropertyImage pImage5 = new PropertyImage();
		pImage5.setFileName("p5.jpg");
		pImage5.setProperty(p5);
		propertyImageServce.addPropertyImage(pImage5);

		Property p6 = new Property(
				150,1,150,"unfurnished",true,false,2019,Calendar.getInstance().getTime(),
				"Description about property, Description about property, Description about property, Description about property, Description about property, Description about property,",
				ramallah,ra2
				);
		propertyService.addNewProprty(p6);

		PropertyImage pImage6 = new PropertyImage();
		pImage6.setFileName("p6.jpg");
		pImage6.setProperty(p6);
		propertyImageServce.addPropertyImage(pImage6);
	}

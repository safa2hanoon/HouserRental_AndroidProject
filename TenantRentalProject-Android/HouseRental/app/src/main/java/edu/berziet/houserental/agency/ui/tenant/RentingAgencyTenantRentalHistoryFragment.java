...
public class RentingAgencyTenantRentalHistoryFragment extends Fragment {
    ...
    public RentingAgencyTenantRentalHistoryFragment() {
    }
    public static RentingAgencyTenantRentalHistoryFragment newInstance(String tenantId) {
        RentingAgencyTenantRentalHistoryFragment fragment = new RentingAgencyTenantRentalHistoryFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String url = String.format(ApiUrl.TENANT_RENTAL_HISTORY_URL,tenantId);
